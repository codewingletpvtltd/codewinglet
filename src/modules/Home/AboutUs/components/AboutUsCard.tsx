...
const AboutUsCard: FC<AboutUsCardProps> = ({ image, title, description }) => (
  <div className='2xl:w-[414px] xl:w-[425px] lg:w-[269px] md:w-[342px] w-full bg-primary px-[15px] pt-[15px] pb-5 2xl:mb-[50px] xl:mb-10 md:mt-0 sm:mt-5 mb-15 last:mb-0'>
