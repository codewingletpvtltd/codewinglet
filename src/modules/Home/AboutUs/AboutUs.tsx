...
import image1 from './about-bg-boxline.png';

const AboutUs = () => {
  console.log('aasjfgauidgsfuvahgsdfkaghsdukh');
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `url(${
          require('./about-bg-boxline.png').default.src
        })`,
        ...
        <div className='flex gap-5 mt-12'>
          <div className='w-[70%] pr-[60px]'>
            ...
            >
              ...
              deep industry insights and collaboration. We boost client growth
              by leveraging our innovative ecosystem to facilitate IT knowledge
