...
const ServiceCard: React.FC<ServiceCardProps> = ({
  ...
  <div className='bg-gray-800 md:p-[30px] p-[15px] lg:mb-10 md:mb-[25px] mb-[15px] last:mb-0 flex md:gap-5 gap-[15px] group cursor-pointer'>
    ...
    <div>
      ...
      <Typography className='lg:text-paragraph2Light md:text-paragraph2Light text-tagExtraLight text-gray-400'>
        {description}
      </Typography>
    </div>
  </div>
