...
const ScrollHighlightNavbar: React.FC<ScrollHighlightNavbarProps> = ({
  ...
  return (
    <div className='2xl:w-1/4 xl:w-[27%] w-full lg:p-0 p-5 bg-white lg:sticky fixed lg:z-0 z-10 right-auto lg:top-[230px] md:top-[90px] top-[128px] lg:left-auto left-0'>
