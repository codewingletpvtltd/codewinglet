...
const PrivacyPolicy = () => {
  ...
  return (
    <>
      <div className='bg-gray-50 lg:mt-[139px] md:mt-[66px] mt-[59px] py-[15px] md:py-[30px] lg:fixed lg:top-0 fixed md:top-[90px] top-[130px] w-full z-10'>
      ...
      <div className='bg-white mt-[230px] [scroll-behavior:_smooth;]'>
          ...
          <div className='lg:flex block gap-[100px] items-start mb-[50px] pt-0'>
            ...
            <div className='2xl:w-[70%] xl:w-[67%] w-full'>
              ...
              >
                ...
                <Typography className='text-paragraph1ExtraLight text-gray-400 pb-10'>
                  Make sure you are aware that by accessing and using{' '}
                  <Link
                    href='http://codewinglet.com'
                    className='text-paragraph1 text-gray-800'
                  >
                ...
                <ul className='grid gap-[30px] ml-5'>
                  <li className='text-paragraph1Light list-disc'>
                    ...
                    <Typography className='text-paragraph1ExtraLight text-gray-400 pt-2.5'>
                      ...
                      <Link
                        ...
                        className='text-gray-800 text-paragraph1'
                      >
                  ...
                  <li className='text-paragraph1Light list-disc'>
                    Cookies
                    <Typography className='text-paragraph1ExtraLight text-gray-400 pb-3 pt-2.5'>
                      Cookies are little files that are kept on your PC or
                      mobile device.
                    </Typography>
                    <Typography className='text-paragraph1ExtraLight text-gray-400'>
              ...
              <div className='mt-[50px] scroll-mt-56' id='types' ref={typesRef}>
                ...
                <Typography className='text-paragraph1ExtraLight text-gray-400 pb-5'>
              ...
              >
                ...
                <ul className='my-[25px] grid gap-5'>
                  <li className='list-disc ml-5 text-paragraph1Light'>
                    ...
                    <Typography className='text-paragraph1ExtraLight text-gray-800 pt-2.5'>
