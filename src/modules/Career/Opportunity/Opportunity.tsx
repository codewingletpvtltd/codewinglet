...
const Opportunity = () => (
  <div className='bg-white' id='career'>
    <div className='bg-dotPattern mx-auto lg:flex block gap-[100px] 2xl:items-center items-end justify-between md:pt-5 pt-10'>
      <div className='2xl:w-[874px] md:w-[680px] 2xl:ml-64 lg:ml-20 md:ml-10 md:pl-[15px] pl-5 md:pr-0 pr-5 2xl:py-0 lg:py-[74px]'>
        ...
        />
        <div className='flex cursor-pointer text-gray-800 mt-[30px] items-center group gap-2.5'>
          <Link
            href='#jobs'
            target='_parent'
