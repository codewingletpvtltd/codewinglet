...
const Card: FC<CardProps> = ({ index, title, desc }) => (
  <div className='lg:border-t-0 border-t border-gray-400 text-white lg:before:absolute before:content before:bg-white before:w-9 before:h-[3px] before:-top-1 lg:w-auto sm:w-6/12 w-full'>
    ...
    <Typography className='text-gray-400 text-paragraph2Light lg:pb-0 pb-10'>
      {desc}
    </Typography>
  </div>
);
