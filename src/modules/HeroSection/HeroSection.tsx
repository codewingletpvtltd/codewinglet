...
const HeroSection = () => (
  <div className='relative bg-aliceBlue z-0'>
    <div className='container relative'>
      <div className='2xl:max-w-screen-2xl xl:max-w-screen-xl lg:max-w-screen-lg md:w-full px-[20px] sm:p-0 mx-auto flex flex-col items-center'>
        <div className='flex items-center max-sm:flex-col md:gap-[35px] lg:gap-[75px] xl:gap-[140px] lg:w-full relative flex-col md:flex-row'>
          <div className='relative lg:self-end'>
            ...
            >
              have a concept for project? connect with code winglet right away
              to secure a technologically advanced and economically efficient
      ...
      <HiringBoard>Clike here to apply</HiringBoard>
    </div> */}
    </div>
