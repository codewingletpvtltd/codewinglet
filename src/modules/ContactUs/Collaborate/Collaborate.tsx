    ...
    <div className='container w-full lg:px-[15px] sm:px-[30px] px-[20px] mx-auto'>
      <div className='flex justify-between items-center'>
        ...
        <div className='relative 2xl:w-[1024px] xl:w-[800px] 2xl:pl-[30px] xl:pl-0'>
          ...
          />
          <Typography className='lg:text-paragraph1ExtraLight sm:text-paragraph1ExtraLight text-tagLight sm:mt-[30px] mt-5 2xl:mb-14 xl:mb-[50px] flex flex-wrap lg:justify-start sm:justify-center justify-start gap-[18px]'>
          ...
          <Typography className='sm:text-paragraph1ExtraLight text-tagLight text-secondary lg:text-left sm:text-center text-left lg:mb-0 sm:mt-10 mb-5 mt-5'>
            Book your Free
