...
const HeroSection = () => (
  <div className='overflow-hidden relative -z-10 pt-[50px]'>
    ...
    <Image
      ...
      className='absolute left-[20px] top-[195px] lg:top-[250px] lg:left-[70px] xl:left-[120px] 2xl:left-[300px] 2xl:top-[200px]'
      alt={'StarsSVG'}
      width={30}
      height={30}
    />
    <Image
      ...
      className='absolute right-[36px] top-[140px] lg:top-[170px] lg:right-[70px] xl:right-[120px] 2xl:right-[300px]'
      alt={'RectangleSVG'}
      width={30}
      height={30}
    />
    <Image
      ...
      className='absolute -z-1 right-0 -z-1 top-[-500px] md:top-[-100px] xl:top-[-50px]'
      alt={'RightLineSVG'}
      width={30}
      height={30}
    />
