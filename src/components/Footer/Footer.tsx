  ...
  return (
    <footer className='max-w-screen-2xl px-4 py-12 relative mx-auto bg-black text-white font-secondary sm:px-6 lg:px-8'>
      <FooterSliceIcon
        ...
        className='absolute top-[35%] left-[2%] xs:hidden lg:block lg:w-[65px] lg:h-[82px] xl:w-[80px] xl:h-[101px]'
      />
      ...
      <FooterTriangleIcon
        ...
        className='absolute bottom-[25%] right-[5%] xs:hidden lg:block lg:bottom-[25%] lg:right-[5%] lg:w-[60px] lg:h-[79px] xl:w-[87px] xl:h-[115px]'
      />
