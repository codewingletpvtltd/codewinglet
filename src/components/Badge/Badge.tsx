...
const Badge: React.FC<BadgeProps> = ({
  ...
  // Define color classes for badge background and border
  const colorClasses = {
  ...
  const badgeStyles = clsx(
    'absolute flex items-center justify-center font-bold text-white rounded-full border',
    sizeClasses[size],
    colorClasses[color],
  ...
  return (
    <div className='relative inline-flex items-center'>
      {children}
      <span className={badgeStyles}>{content}</span>
    </div>
  );
};
