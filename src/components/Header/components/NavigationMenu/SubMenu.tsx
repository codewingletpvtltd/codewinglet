...
export const ServicesContent: FC<SubMenuContentProps> = ({
  ...
  <>
    <ul className='grid grid-rows-5 grid-flow-col 2xl:grid-cols-[31%_25%_25%] xl:grid-cols-[31%_25%_25%] 2xl:gap-9 xl:gap-5 xl:gap-x-[30px] after:content after:absolute 2xl:after:top-[13%] xl:after:top-[15%] after:left-[32%] after:bg-gray-100 after:w-[1px] 2xl:after:h-[81%] xl:after:h-[78%] before:content before:absolute 2xl:before:top-[13%] xl:before:top-[15%] before:left-[58%] before:bg-gray-100 before:w-[1px] 2xl:before:h-[81%] xl:before:h-[78%]'>
    ...
    <div className='bg-[#F4F4F4] flex items-center absolute right-[30px] bottom-[30px] w-[37%] p-4 gap-2'>
      <Typography className='text-paragraph1Light text-gray-800 w-3/5'>
      ...
      >
        <Button
          variant='default'
          className='bg-gray-800 w-[223px] m-[initial] gap-3 !text-paragraph1 text-white py-3'
        >
          Schedule a call
          <Arrow />
        </Button>
...
export const TechnologyContent: FC<SubMenuContentProps> = ({
  ...
  <>
    ...
    <div className='bg-[#F4F4F4] flex items-center justify-between right-[30px] bottom-[30px] w-full p-2.5 mt-9 pl-6'>
      <Typography className='text-paragraph1 text-gray-800 w-3/5'>
...
export const IndustryContent: FC<SubMenuContentProps> = ({
  ...
  <>
    <div className='flex 2xl:gap-3 xl:gap-10'>
      <ul className='w-[935px] grid grid-rows-4 grid-flow-col grid-cols-[35%_22%_35%] gap-6 before:content before:absolute before:top-[17%] 2xl:before:left-[65%] xl:before:left-[66%] before:bg-gray-100 before:w-[1px] before:h-[75%]'>
        {childItems.map((menu, menuIdx) => (
          <ListItem
            key={`menu-header-${index}-${menuIdx}`}
            icon={menu.icon}
      ...
      <div>
        <Typography className='text-h5 text-gray-800'>
          Our Industry experts
        </Typography>
        <Typography className='text-gray-400 text-tagLight mb-2.5'>
