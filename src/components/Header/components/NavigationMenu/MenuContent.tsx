...
const MenuContent: FC<MenuContentProps> = ({
  ...
  >
    <div
      className={getClassNames(
        'bg-white h-max p-[30px] gap-[15px] top-full mt-[34px] z-10 2xl:min-w-[1380px] xl:min-w-[1250px] 2xl:max-w-[1380px] xl:max-w-[1250px] w-full border-gray-100 border rounded-sm',
        className
      )}
    >
      {children}
