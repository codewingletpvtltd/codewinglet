    ...
    <div className={getClassNames('flex flex-col', rootClasseName)}>
      ...
      <div className='inline-block'>
        <textarea
          ...
          disabled={disabled}
          className={getClassNames(
            'rounded-none border-solid  placeholder:text-gray-200 bg-transparent pt-2.5 w-[200px] sm:text-paragraph1ExtraLight text-tag focus:outline-none focus:border-gray-800',
