...
const MenuIcon: FC<MenuIconProps> = ({ isOpen, onClick }) => (
  <div
    className={getClassNames(
      ...
      '[&>span]:block [&>span]:absolute [&>span]:h-[2px] [&>span]:w-[22px] [&>span]:bg-white [&>span]:opacity-100 [&>span]:left-0 [&>span]:rounded-[4px] [&>span]:transition-transform [&>span]:rotate-0 [&>span]:duration-300 [&>span]:ease-in-out',
