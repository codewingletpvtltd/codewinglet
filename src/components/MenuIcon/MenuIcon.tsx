...
const MenuIcon: FC<MenuIconProps> = ({ isOpen, onClick, className = '' }) => (
  <div
    className={getClassNames(
      'relative w-5 h-5 my-[50px] cursor-pointer transition-transform rotate-0 duration-500 ease-in-out block xl:hidden',
      ...
      '[&>span:nth-child(1)]:top-0 [&>span:nth-child(2)]:top-[8px] [&>span:nth-child(3)]:top-[8px] [&>span:nth-child(4)]:top-4',
      isOpen
