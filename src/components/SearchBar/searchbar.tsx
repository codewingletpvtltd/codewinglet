...
export const BlogSearch = () => {
  ...
  return (
    <div className='bg-white w-full shadow-custom'>
        ...
        <div className='flex'>
          <div className='relative'>
            ...
            <input
              ...
              className='md:w-[383px] sm:w-[290px] w-[250px] placeholder:text-gray-400 lg:border lg:border-gray-100 sm:pr-9 pr-6 lg:py-[13px] py-2.5 lg:pl-[58px] pl-[38px] text-paragraph2Light focus:outline-0'
              value={inputValue}
